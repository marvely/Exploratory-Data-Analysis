...
#
#
 plot( epc.sub$Voltage, xaxt="n", type = "l", xlab = "datetime", ylab = "Voltage")
 axis( side = 1, at=c(1,1441,2881), labels = c("Thu","Fri","Sat"))
#
#
...
#
#
 plot( epc.sub$Global_reactive_power, xaxt="n", type = "l", xlab = "datetime", ylab = "Global_reactive_power")
 axis( side = 1, at=c(1,1441,2881), labels = c("Thu","Fri","Sat"))
#
#
 dev.off() 
